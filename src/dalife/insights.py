...
from dalife.archive_values import clean, confidence, json_string_list as json_list
from dalife.models import ArchiveItemRecord, InsightEvidenceRecord, InsightNoteRecord
from dalife.ports import InsightSynthesisStore
from dalife.readiness import candidate_reasons, related_match
    ...
    *,
    ...
    if len(rows) < MIN_EVIDENCE_ITEMS:
        return {
            ...
            "next_step": "Process more captures or run `dalife reprocess-plan` to improve archive quality.",
        }
