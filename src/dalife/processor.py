...
from dalife.codex_harness import (
...
from dalife.models import CaptureFileRecord, CaptureRecord
from dalife.ocr import OcrAdapter, TesseractOcrAdapter
from dalife.ports import ProcessingStore
from dalife.state import file_lock
