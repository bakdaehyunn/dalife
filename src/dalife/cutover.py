...
DALIFE_TELEGRAM_LABEL = "com.hennei.dalife.telegram"
DALIFE_LIFE_LABEL = "com.hennei.dalife.life-send"
    ...
    *,
    ...
    checks = [
        ...
        _check(
            ...
            "Set DALIFE_NATIVE_PERSONAL_TELEGRAM=true only for the controlled cutover.",
        ),
        _check(
            "dalife_telegram_loaded",
            DALIFE_TELEGRAM_LABEL in snapshot.loaded_labels,
            "Load the DaLife Telegram agent before retiring the legacy reply watcher.",
        ),
        _check(
            "life_sender_plist_ready",
            DALIFE_LIFE_LABEL in snapshot.present_plists,
