...
from darchivebot.domains.course.models import CoursePlan
from darchivebot.domains.course.planner import (
    CoursePlanningContext,
    compose_course_plan,
    persist_course_plan,
)
from darchivebot.domains.food import FoodRecommendationContext, recommend_local_food
from darchivebot.models import AreaRecord, CoursePlanRecord
from darchivebot.ports import PersonalContextRepositoryPort, SearchRepositoryPort
