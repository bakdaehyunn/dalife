...
from darchivebot.domains.life.defaults import FixedReminderSpec, fixed_specs_by_kind, get_fixed_spec
from darchivebot.domains.life.messages import card
from darchivebot.domains.life.patterns import MessagePattern
