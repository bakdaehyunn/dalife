...
from darchivebot.scheduler import ScheduledJob, launchd_schedule


PATH_VALUE = "/opt/homebrew/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"

LABELS = {
    "telegram": "com.hennei.darchivebot.telegram",
    "archive-process": "com.hennei.darchivebot.processor",
    "food-collect": "com.hennei.darchivebot.food-collect",
    "life-send": "com.hennei.darchivebot.life-send",
    "revisit-digest": "com.hennei.darchivebot.digest",
    "project-seed-digest": "com.hennei.darchivebot.digest.project-seed",
    "weekly-insight": "com.hennei.darchivebot.digest.weekly",
}
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="python -m darchivebot.launchd")
